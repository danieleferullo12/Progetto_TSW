 ...
 <div id="search-bar">
  ...
  <button type="submit">Cerca</button>
   ...
   %>
    ...
    <li><a href="<%=request.getContextPath()%>/carrello"><span>Carr</span>ello<span id="contatoreCar">
  ...
  <nav>
  <ul>
   <li><a href="<%=request.getContextPath()%>/categoria?categoria=1">PROTEINE</a>
   <li><a href="<%=request.getContextPath()%>/categoria?categoria=2">ABBIGLIAMENTO</a>
   <li><a href="<%=request.getContextPath()%>/categoria?categoria=3">ACCESSORI</a>
   <li><a href="<%=request.getContextPath()%>/categoria?categoria=4">ALIMENTAZIONE</a>
